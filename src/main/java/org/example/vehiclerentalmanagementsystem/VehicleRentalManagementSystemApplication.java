...
public class VehicleRentalManagementSystemApplication {
    ...
    @Bean
    public CommandLineRunner demoData(UserService userService, VehicleService vehicleService) {
        return args -> {
            try {
                // Create Sample Users
                ...
                System.out.println("Sample data initialization skipped (likely already exists): " + e.getMessage());
            }
        };
    }
}
